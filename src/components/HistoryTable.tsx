      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-100">
            <th className="text-left py-2 px-3 text-gray-500 font-medium w-16">회차</th>
            <th className="text-left py-2 px-3 text-gray-500 font-medium">당첨번호</th>
            <th className="text-left py-2 px-3 text-gray-500 font-medium w-20">보너스</th>
          </tr>
        </thead>
        <tbody>
          {draws.map((draw) => (
            <tr key={draw.drwNo} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
              <td className="py-2 px-3 font-semibold text-gray-700">{draw.drwNo}</td>
